    ...
    <>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <AppWidgetSummary title="Ventas Concretadas" top={2} total={60} color="primary" icon={'ant-design:apple-filled'} />
          </Grid>

          <Grid item xs={12} sm={6} md={4}>
            <AppWidgetSummary title="Ventas Concretadas" top={3} total={58} color="warning" icon={'ant-design:windows-filled'} />
          </Grid>
